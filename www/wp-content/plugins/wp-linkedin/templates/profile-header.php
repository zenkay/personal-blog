<div id ="cartouche" class="section">
	<a href="<?php echo esc_url($profile->publicProfileUrl); ?>"><img class="picture" src="<?php echo esc_url($profile->pictureUrl); ?>" width="80" alt="<?php echo $profile->firstName; ?> <?php echo $profile->lastName; ?>"/></a>
